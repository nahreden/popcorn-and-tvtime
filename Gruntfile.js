  ...
  grunt.initConfig({
    ...
    nodewebkit: {
      build: {
        ...
        src: ['./css/**', './fonts/**', './images/**', './js/**', './language/**', './node_modules/**', '!./node_modules/grunt*/**', './rc/**', './Config.rb', './index.html', './popcorn-and-tvtime.html', './tvtime.html', './package.json', './README.md' ] // Your node-webkit app './**/*'
      },
      dist: {
        options: {
          version: '0.9.2',
    ...
    copy: {
        ...
        files: [
          {
            ...
            dest: 'build/releases/Popcorn-and-tvTime/win/Popcorn-and-tvTime/ffmpegsumo.dll',
            flatten: true
          },
          {
            src: 'libraries/win/ffmpegsumo.dll',
          ...
          },
          {
            ...
            dest: 'build/releases/Popcorn-and-tvTime/mac/Popcorn-and-tvTime.app/Contents/Frameworks/node-webkit Framework.framework/Libraries/ffmpegsumo.so',
            flatten: true
          },
          {
            src: 'libraries/mac/ffmpegsumo.so',
          ...
          },
          {
            ...
            dest: 'build/releases/Popcorn-and-tvTime/linux64/Popcorn-and-tvTime/libffmpegsumo.so',
            flatten: true
          },
          {
            src: 'libraries/linux64/libffmpegsumo.so',
          ...
          },
          {
            ...
            dest: 'build/releases/Popcorn-and-tvTime/linux32/Popcorn-and-tvTime/libffmpegsumo.so',
            flatten: true
          },
          {
            src: 'libraries/linux32/libffmpegsumo.so',
      ...
      package: {
        files: [
          {
            src: 'build/releases/Popcorn-and-tvTime/TV-Time.nw',
            dest: 'build/releases/Popcorn-and-tvTime/linux32/Popcorn-and-tvTime/package.nw',
            flatten: true
          },
          {
            src: 'build/releases/Popcorn-and-tvTime/TV-Time.nw',
            dest: 'build/releases/Popcorn-and-tvTime/linux64/Popcorn-and-tvTime/package.nw',
            flatten: true
          }
        ]
      }
